myApp.controller("blogController",function($scope,$location,$rootScope,$http,$cookieStore)
	...
	$scope.addBlog=function()
	{
		...
		$http.post('http://localhost:9092/ConnectPeopleMiddle/addBlog',$scope.Blog)
	...
	$scope.updateBlog=function()
	{
		...
		$http.post('http://localhost:9092/ConnectPeopleMiddle/updateBlog',$rootScope.blog1)
		.then(function(response)
		{
			alert("Blog Updated");
	...
	$scope.incrementLikes=function(blogid)
	{
		...
		$http.post('http://localhost:9092/ConnectPeopleMiddle/incrementLikes/'+blogid)
		.then(function(response)
		{
	...
	$scope.incrementDisLikes=function(blogid)
	{
		...
		$http.post('http://localhost:9092/ConnectPeopleMiddle/incrementDisLikes/'+blogid)
		.then(function(response)
		{
	...
	$scope.accept=fuction(blogid)
	{
		...
		$http.post('http://localhost:9092/ConnectPeopleMiddle/approveBlog/'+blogid)
		.then(function(response)
		{
			alert("Blog Approved")
		},function(errorresponse)
	...
	$scope.reject=fuction(blogid)
	{
		...
		$http.post('http://localhost:9092/ConnectPeopleMiddle/rejectBlog/'+blogid)
		.then(function(response)
		{
			alert("Blog Rejected")
		},function(errorresponse)
	...
	$scope.deleteBlog=function(blogid)
	{
		...
		$http.post('http://localhost:9092/ConnectPeopleMiddle/deleteBlog/'+blogid)
		.then(function(response)
		{
	...
	$scope.editBlog=function(blogid)
	{
		...
		$http.post('http://localhost:9092/ConnectPeopleMiddle/getSingleBlog/'+blogid)
		.then(function(response)
		{
	...
	$http.post('http://localhost:9092/ConnectPeopleMiddle/showAllBlog')
	.then(function(response)
	{
