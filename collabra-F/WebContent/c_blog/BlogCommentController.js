myApp.controller("BlogCommentController",function($scope,$rootScope,$http,$location)
{
    ...
    function loadAllComments()
    {
    	...
    	$http.get('http://localhost:9092/ConnectPeopleMiddle/getAllBlogComment/'+$rootScope.blogid)
    ...
    function blogInfo()
    {
    	...
    	$http.get('http://localhost:9092/ConnectPeopleMiddle/getSingleBlog/'+$rootScope.blogid)
		.then(function(response)
		{
    ...
    $scope.addComment=function()
    {
    	...
    	$http.post('http://localhost:9092/ConnectPeopleMiddle/addBlogComment/'+$rootScope.blogid)
		.then(function(response)
		{
    ...
    $scope.deleteComment=function(blogcommentid)
    {
    	...
    	$http.post('http://localhost:9092/ConnectPeopleMiddle/deleteBlogComment/'+$rootScope.blogid)
		.then(function(response)
		{
