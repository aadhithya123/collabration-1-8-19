myApp.controller("UserController",function($scope,$http,$rootScope,$location,$cookieStore)
  ...
  //===============================================CHECK USER=================================================================================
	...
	$scope.editUser=function()
	{
		...
		$http.get('http://localhost:9092/ConnectPeopleMiddle/get/'+$rootScope.currentUser.username)
		.then(function(response)
		{
	...
	{
		$http.post('http://localhost:9092/ConnectPeopleMiddle/updateUser',$rootScope.userDetails1)
		.then(function(response)
		{
			alert(response.data);
		},function(errorresponse)
